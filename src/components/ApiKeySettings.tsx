			...
			<div className="relative bg-white shadow-xl w-full max-w-md mx-4 p-6">
					...
					<div>
						...
						<div className="relative">
							<input
								...
								placeholder="sk-..."
								className="w-full px-3 py-2 pr-10 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
							/>
							<button
								type="button"
				...
				<div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-200">
					<button
						onClick={handleClear}
						disabled={!hasAnyKeys}
						className="px-3 py-2 text-sm text-red-600 hover:text-red-800 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
					>
						Clear All Keys
					</button>
					...
					<div className="flex gap-3">
						<button
							...
							className="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-50 transition-colors"
						>
							Cancel
						</button>
						<button
